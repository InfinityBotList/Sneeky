            ...
            return interaction.reply({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            "You have collected today's earnings of '$25' come back tomorrow to claim again"
                        )
                        .setTimestamp()
                        .setFooter({
                            text: `${this.bot.credits}`,
            ...
            return interaction.reply({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setThumbnail(this.bot.logo)
                        .setDescription(
                            `Please wait: ${hours}h ${minutes}m ${seconds}s before you can claim your daily earnings again`
                        )
                        .setTimestamp()
                        .setFooter({
                            text: `${this.bot.credits}`,
