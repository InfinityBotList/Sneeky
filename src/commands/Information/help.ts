                    ...
                    new MessageSelectMenu()
                        ...
                        .addOptions([
                            ...
                            },
                            {
                                ...
                                value: "info",
                                description:
                                    "View all the information category commands",
                            },
                            {
                                label: "Economy Commands",
                                value: "economy",
                                description:
                                    "View all the economy category commands",
                            },
                            {
                                label: "Fun Commands",
                                value: "fun",
                                description:
                                    "View all the fun category commands",
                            },
                            {
                                label: "Support Commands",
                                value: "support",
                                description:
                                    "View all the support category commands",
                            },
                            {
                                label: "Image Commands",
                                value: "image",
                                description:
                                    "View all the image category commands",
                            },
                            {
                                label: "NSFW Commands",
                                value: "nsfw",
                                description:
                                    "View all of the nsfw category commands",
                            },
                            {
                                label: "Utility Commands",
                                value: "utility",
                                description:
                                    "View all of the utility category commands",
                            },
                        ])
                ),
            ];
            ...
            await interaction.reply({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setThumbnail(this.bot.logo)
                        .setDescription(
                            "Feeling lost? you can find a list of commands here sorted by category"
                        )
                        .setTimestamp()
                        .setFooter({
                            text: `${this.bot.credits}`,
                ...
                if (interaction.values[0] === "main") {
                    await interaction.update({
                        embeds: [
                            new MessageEmbed()
                                .setTitle(
                                    `Help for: ${this.bot.client.user?.username}`
                                )
                                .setColor(this.bot.colors.embed)
                                .setThumbnail(this.bot.logo)
                                .setDescription(
                    ...
                    await interaction.update({
                        embeds: [
                            new MessageEmbed()
                                ...
                                .setThumbnail(this.bot.logo)
                                .setDescription(
                                    "You can use `/help <cmdName>` to view command related help"
                                )
                                .addFields({
