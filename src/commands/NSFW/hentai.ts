...
export default class extends Command {
    ...
    constructor(bot: any) {
        ...
        super(bot, {
            ...
            aliases: [],
            options: [],
            description: 'Send a random hentai',
            category: 'NSFW',
            cooldown: 5,
            userPermissions: [],
            botPermissions: [],
    ...
    async execute(interaction: ICommandInteraction) {
        ...
        if ((!interaction.channel.nsfw)) {
            ...
            return interaction.reply({ embeds: [
                new MessageEmbed()
                 ...
                 .setDescription(`Hang on there horn dog, nsfw commands should be executed in a [nsfw/age restricted channel](https://support.discord.com/hc/en-us/articles/115000084051-Age-Restricted-Channels-and-Content#h_adc93a2c-8fc3-4775-be02-bbdbfcde5010)`)
                 .setTimestamp()
                 .setFooter({
        ...
        const res = await fetch(`https://nekobot.xyz/api/image?type=hentai`).then(r => r.json());
        ...
        collector.on('collect', async (i: any) => {
            ...
            const res2 = await fetch(`https://nekobot.xyz/api/image?type=hentai`).then(r => r.json());
