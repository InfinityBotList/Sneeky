...
export default class extends Command {
    ...
    constructor(bot: any) {
        ...
        super(bot, {
            ...
            aliases: [],
            options: [],
            description: 'Generate some pussy',
            category: 'NSFW',
            cooldown: 5,
            userPermissions: [],
            botPermissions: [],
    ...
    async execute(interaction: ICommandInteraction) {
        ...
        const res = await fetch(`https://nekobot.xyz/api/image?type=pussy`).then(r => r.json());
        ...
        collector.on('collect', async (i: any) => {
            ...
            const res2 = await fetch(`https://nekobot.xyz/api/image?type=pussy`).then(r => r.json());
